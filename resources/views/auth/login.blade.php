...
<form  method="POST" action="{{ route('login') }}">
    ...
    <div class="inputGroup inputGroup2">
        ...
        @if (Route::has('password.request'))
            <a class="" href="{{ route('password.request') }}" style="color: #217093">
    ...
    <div class="text-end">
        Does not have an account? <a href="{{ route('register') }}" style="color: #217093">Register here</a>
    </div>

</form>
<script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js"></script>
<script  src="{{asset('LoginFormResource/script.js')}}"></script>
</body>
</html>
